      ...
      <motion.div
        ...
        variants={scrollAnimation}>
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-end-1">
            <h1 className="font-serif text-4xl lg:text-6xl xl:text-5xl font-medium text-black-600 leading-normal">Mang Rey's Mushroom Chicharon </h1>
            <p className="text-black-500 lg:text-lg mt-4 mb-6">
              a plant-based oyster mushroom special chicharon, 
              a fresh take on a Filipino favorite. It's crispy, 
              flavorful, and completely vegan, making 
              it a great and environmentally friendly snack.
            </p>
            <LinkScroll
            activeClass="active"
            to="feature"
